...
import Web_Board_dao.Web_Board_Dao_Impl;
import Web_Board_dto.Pagination;

public class Web_Board_ServiceImpl implements Web_Board_Service {
	...
	public Pagination getPagination(int c, int countPerPage) {
		...
		Web_Board_Dao_Impl a = new Web_Board_Dao_Impl(); //dao구현체의 함수를 불러오기 위해 객체 선언
