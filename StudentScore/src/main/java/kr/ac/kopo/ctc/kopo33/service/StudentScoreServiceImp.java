...
import kr.ac.kopo.ctc.kopo33.dao.StudentScoreDao;
	...
	public class StudentScoreServiceImp implements StudentScoreService { //StudentScoreService 인터페이스를 구현
		...
		public Pagination getPagination(int c, int countPerPage) { 
			...
			StudentScoreDaoImp a = new StudentScoreDaoImp(); //dao구현체의 함수를 불러오기 위해 객체 선언
...
//		
//		pagination.setC(settingC(page));
//		pagination.setS(settingS(settingC(page)));
//		int is = settingS(settingC(page));
//		pagination.setE(settingE(is, lastpage));
//		pagination.setP(settingP(settingC(page), is));
//		pagination.setPp(settingPp(is));
//		pagination.setN(settingN(settingC(page), settingE(is, lastpage)));
//		pagination.setNn(settingNn(settingE(is, lastpage)));
//	      
//	      return pagination;
//	
//	}
//
//		public int settingC(int page) {
//			if(page<=0) {
//				return 1;	
//			}else {
//				if(page<lastpage) {
...
//		
//	}
//		public int settingS(int a) {   
//	      return ((a-1)/cnt) * cnt + 1; 
//	   }
//	   
//		public int settingE(int S, int last_page) {
//	      return Math.min(last_page, S + cnt - 1);
//	   }
//	   // <
//	   public int settingP(int C, int S) {
//	      if (S <= cnt) {
//	         return -1;
//	      } else {
//	         return C - 10;
...
//	   }
//	   //N >
//	   public int settingN(int C, int E) {
//	      if (E == lastpage) {
//	         return -1;
//	      } else {
//	         if (C + 10 > lastpage) {
